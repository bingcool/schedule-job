 ...
 *
 * **生产者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Controller\CronTaskManagerController::listTasks} 从
 * {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Request\CronTaskManager\ListTasksRequest} 映射字段后构造。
 *
 * **消费者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::listTasks} 读取过滤条件
 * 与分页参数，返回 {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Response\CronTaskManager\ListTasksPageResult}。
 *
 * **关键字段语义**：
