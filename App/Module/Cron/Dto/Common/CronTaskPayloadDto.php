 ...
 *
 * **生产者**：{@see \App\Module\Cron\Service\CronTaskPayloadBuilder::build} 校验原始 payload
 * 后逐字段 put 构造。
 *
 * **消费者**：{@see \App\Module\Cron\Service\CronTaskManagerService} 调用 {@see toEntityArray}
 * 转为 snake_case 关联数组后写入 {@see \App\Module\Cron\Entity\CronTaskEntity}。
 *
 * **关键字段语义**：
