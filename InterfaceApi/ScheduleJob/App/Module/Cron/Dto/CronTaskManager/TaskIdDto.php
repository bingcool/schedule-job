 ...
 *
 * **生产者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Controller\CronTaskManagerController::deleteTask} 通过
 * {@see static::of} 从 Request 的 id 构造。
 *
 * **消费者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::deleteTask} 校验 id 并执行删除。
 *
