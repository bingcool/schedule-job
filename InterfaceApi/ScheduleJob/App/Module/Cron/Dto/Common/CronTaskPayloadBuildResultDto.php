 ...
 *
 * **生产者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskPayloadBuilder::build} 校验通过后调用
 ...
 * {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::updateTask} 通过 {@see hasError}
 * 判断后取 payload 或错误信息。
 *
 * **关键字段语义**（互斥）：
