 ...
 *
 * **生产者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Controller\CronTaskManagerController::taskLogs} 从
 * {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Request\CronTaskManager\TaskLogsQueryRequest} 映射字段。
 *
 * **消费者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::taskLogs} 可选按 cron_id 过滤
 * 并返回 {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Response\CronTaskManager\TaskLogsPageResult}。
 *
 * **关键字段语义**：
