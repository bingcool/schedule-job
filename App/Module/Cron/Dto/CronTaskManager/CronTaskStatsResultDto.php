 ...
 *
 * **生产者**：{@see \App\Module\Cron\Service\CronTaskManagerService::taskStats}
 * 通过 SQL `GROUP BY status` 聚合，再由 {@see static::fromAggregated} 组装。
 *
 * **消费者**：{@see \App\Module\Cron\Controller\CronTaskManagerController::taskStats} 组装
 * {@see \App\Module\Cron\Response\CronTaskManager\CronTaskStatsResponse}。
 *
 * **关键字段语义**：
