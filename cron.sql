...
INSERT INTO `cron_task` (`id`, `cron_name`, `expression`, `command`, `exec_type`, `status`, `with_block_lapping`, `description`, `cron_between`, `cron_skip`, `http_method`, `http_body`, `http_headers`, `http_request_time_out`, `created_at`, `updated_at`, `deleted_at`) VALUES (6, '修复用户数据', '25', 'php /home/wwwroot/swoolefy/script.php start Test --c=test:script', 1, 1, 0, '', NULL, NULL, '', NULL, NULL, 0, '2025-04-27 09:51:55', '2025-04-27 19:53:01', NULL);
