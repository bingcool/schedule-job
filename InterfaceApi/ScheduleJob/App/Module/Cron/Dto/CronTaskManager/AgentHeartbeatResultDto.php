 ...
 *
 * **生产者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::agentHeartbeat} 校验
 * nodeId 后填充 serverTime。
 *
 * **消费者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Controller\CronTaskManagerController::agentHeartbeat}
 * 读取字段并组装 {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Response\CronTaskManager\CronAgentHeartbeatResponse}。
 *
 * **关键字段语义**：
 * - nodeId：回显请求的节点 ID
