 ...
 *
 * **生产者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Controller\CronTaskManagerController::agentReport} 从
 * {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Request\CronTaskManager\CronAgentReportRequest} 映射字段。
 *
 * **消费者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::agentReport} 校验后
 * 写入 cron_task_log 表。
 *
 * **关键字段语义**：
