 ...
 *
 * **生产者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Controller\CronTaskManagerController::agentTasks} 从
 * {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Request\CronTaskManager\CronAgentTasksQueryRequest} 映射字段。
 *
 * **消费者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::agentTasks} 委托
 * {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskService::fetchCronTask} 查询并返回
