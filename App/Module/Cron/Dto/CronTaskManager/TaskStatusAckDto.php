 ...
 *
 * **生产者**：{@see \App\Module\Cron\Service\CronTaskManagerService::switchTaskStatus} 更新
 * 数据库后通过 {@see static::of} 构造。
 *
 * **消费者**：{@see \App\Module\Cron\Controller\CronTaskManagerController::switchTaskStatus}
 * 读取 id / status 并组装 {@see \App\Module\Cron\Response\CronTaskManager\CronTaskStatusAckResponse}。
 *
 * **关键字段语义**：
 * - id：已更新状态的任务 ID
