 ...
 *
 * **生产者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Controller\CronTaskManagerController} 在 createTask / updateTask
 * 中调用 {@see static::fromPayloadArray}，数据来源于 Request::toPayloadArray()。
 *
 * **消费者**：{@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::createTask} 与
 * {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskManagerService::updateTask} 取出数组后交给
 * {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Service\CronTaskPayloadBuilder} 校验并转为 {@see \InterfaceApi\ScheduleJob\App\Module\Cron\Dto\Common\CronTaskPayloadDto}。
 *
