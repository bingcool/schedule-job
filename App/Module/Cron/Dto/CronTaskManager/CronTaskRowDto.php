 ...
 *
 * **生产者**：{@see \App\Module\Cron\Service\CronTaskManagerService::listTasks} 通过
 * {@see static::fromEntityRow} 映射查询行；{@see \App\Module\Cron\Response\CronTaskManager\CronTaskRowResponse}
 * 在 create/update 后同样调用 fromEntityRow。
 *
 * **消费者**：{@see \App\Module\Cron\Response\CronTaskManager\ListTasksPageResult} 收集列表项；
